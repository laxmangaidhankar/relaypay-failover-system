...
const auditLogSchema = new mongoose.Schema({
  ...
  eventType: {
    ...
    required: true,
    enum: [
      'TRANSACTION_INITIATED', 'PRIMARY_ATTEMPT_FAILED', 'RELAY_REQUESTED',
      'RELAY_APPROVED', 'RELAY_DECLINED', 'RELAY_TIMEOUT', 'TRANSACTION_SETTLED',
      'TRANSACTION_REVERSED', 'LOGIN_SUCCESS', 'LOGIN_FAILED', 'REFRESH_TOKEN_REUSE_DETECTED',
      'FAMILY_MEMBER_INVITED', 'FAMILY_MEMBER_ACCEPTED', 'WALLET_FROZEN'
    ]
  },
...
}, { timestamps: false }); // deliberately no updatedAt — this collection is append-only
